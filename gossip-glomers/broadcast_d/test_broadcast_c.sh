...

{
  ...
  echo '{"src":"n2", "dest": "n1", "body":{"type": "gossip_ok", "msg_id": 1, "in_reply_to": 2 }}'
  ...
  echo '{"src":"n2", "dest": "n1", "body":{"type": "gossip_ok", "msg_id": 3, "in_reply_to": 7 }}'
  echo '{"src":"n3", "dest": "n1", "body":{"type": "gossip_ok", "msg_id": 1, "in_reply_to": 8 }}'
